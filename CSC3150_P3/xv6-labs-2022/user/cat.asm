...
cat(int fd)
{
  ...
  44:	8a058593          	addi	a1,a1,-1888 # 8e0 <malloc+0xf4>
  48:	4509                	li	a0,2
  ...
  72:	88a58593          	addi	a1,a1,-1910 # 8f8 <malloc+0x10c>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	80e58593          	addi	a1,a1,-2034 # 910 <malloc+0x124>
 10a:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 56a:	3cab8b93          	addi	s7,s7,970 # 930 <digits>
 ...
 6aa:	28290913          	addi	s2,s2,642 # 928 <malloc+0x13c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8a4:	ec4080e7          	jalr	-316(ra) # 764 <free>
  return freep;
 ...
 8c6:	b6c080e7          	jalr	-1172(ra) # 42e <sbrk>
  if(p == (char*)-1)
