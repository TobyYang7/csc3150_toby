...
00000000000001de <main>:
{
 ...
 252:	81258593          	addi	a1,a1,-2030 # a60 <malloc+0xf4>
 256:	4509                	li	a0,2
 ...
 288:	7fc50513          	addi	a0,a0,2044 # a80 <malloc+0x114>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 61e:	48650513          	addi	a0,a0,1158 # aa0 <digits>
 622:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ea:	3bab8b93          	addi	s7,s7,954 # aa0 <digits>
 ...
 82a:	27290913          	addi	s2,s2,626 # a98 <malloc+0x12c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 a24:	ec4080e7          	jalr	-316(ra) # 8e4 <free>
  return freep;
 ...
 a46:	b6c080e7          	jalr	-1172(ra) # 5ae <sbrk>
  if(p == (char*)-1)
