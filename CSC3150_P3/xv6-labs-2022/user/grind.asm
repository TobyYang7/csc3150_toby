...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    1352:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1354:	02071693          	slli	a3,a4,0x20
    1358:	01c6d713          	srli	a4,a3,0x1c
  ...
  free((void*)(hp + 1));
    138c:	0541                	addi	a0,a0,16
    138e:	00000097          	auipc	ra,0x0
    1392:	ec4080e7          	jalr	-316(ra) # 1252 <free>
  return freep;
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    13b4:	b6c080e7          	jalr	-1172(ra) # f1c <sbrk>
  if(p == (char*)-1)
